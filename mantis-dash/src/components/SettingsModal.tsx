  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-slide-in">
      <div className="glass-card w-full max-w-md p-6 rounded-2xl shadow-2xl relative">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-1.5 rounded-full hover:bg-white/10 transition-colors text-[var(--deploymantis-text-muted)] hover:text-[var(--foreground)]"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-[var(--deploymantis-text-muted)]">Toggle light/dark aesthetic</div>
            </div>
            <div className="flex bg-black/20 p-1 rounded-lg border border-[var(--deploymantis-glass-border)]">
              <button
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              <div>
                ...
                <div className="text-xs text-[var(--deploymantis-text-muted)]">Automatically clear full buffers</div>
              </div>
              <Tooltip.Provider>
                <Tooltip.Root delayDuration={200}>
                  <Tooltip.Trigger asChild>
                    <button className="text-[var(--deploymantis-text-muted)] hover:text-[var(--accent)] transition-colors">
                  ...
                  <Tooltip.Portal>
                    ...
                    >
                      ...
                      <Tooltip.Arrow className="fill-[var(--deploymantis-glass-border)]" />
                    </Tooltip.Content>
                  </Tooltip.Portal>
                </Tooltip.Root>
              </Tooltip.Provider>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-[var(--deploymantis-text-muted)]">Fetch rate for new logs</div>
              </div>
            ...
            />
            <div className="flex justify-between text-[10px] text-[var(--deploymantis-text-muted)] px-1">
              <span>500ms</span>
              <span>5000ms</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="text-xs text-[var(--deploymantis-text-muted)]">Timeline log details level</div>
            </div>
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-lg border text-xs font-medium transition-all ${
                  dataVerbosity === "Compact"
                    ...
                    : "border-[var(--deploymantis-glass-border)] bg-black/10 text-[var(--deploymantis-text-muted)] hover:text-[var(--foreground)]"
                }`}
              >
                Compact
              </button>
