    ...
    <div className="flex flex-col h-full gap-5">
      <header className="px-2 flex items-start justify-between">
        <div>
          ...
          <p className="text-[var(--deploymantis-text-muted)] text-sm mt-1.5 font-mono">Live frame-by-frame analysis of DeployMantis reliability events.</p>
        </div>
        <button
          onClick={() => setIsSettingsOpen(true)}
          className="p-2.5 rounded-xl glass-card text-[var(--deploymantis-text-muted)] hover:text-[var(--foreground)] transition-all duration-300 hover:rotate-90 hover:scale-110"
          title="Settings"
        >
      ...
      <div className="glass rounded-xl overflow-hidden shadow-2xl">
        <div className="flex items-center gap-2 px-4 pt-4 text-[var(--accent)] font-semibold uppercase tracking-widest text-xs border-b border-[var(--deploymantis-glass-border)] pb-3 bg-black/5">
