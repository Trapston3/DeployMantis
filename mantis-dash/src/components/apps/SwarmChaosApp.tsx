    ...
    <div className="flex flex-col h-full gap-5 overflow-y-auto no-scrollbar pb-10">
        ...
        <div className="glass-card rounded-xl p-5 flex flex-col justify-center">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <div className="text-xs text-[var(--deploymantis-text-muted)]">
                Probability of chaos on any request
              </div>
            </div>
            <div className="flex items-center gap-2">
              {syncing && (
                <Loader2 className="w-3.5 h-3.5 animate-spin text-[var(--deploymantis-text-muted)]" />
              )}
          ...
          />
          <div className="flex justify-between text-[10px] text-[var(--deploymantis-text-muted)] px-1 mt-2">
            <span>0%</span>
            <span>50%</span>
            <span>100%</span>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6 px-4">
          {[
            ...
            <div key={item.key} className="flex items-center gap-4">
              <div className="w-32 text-right text-xs font-mono text-[var(--deploymantis-text-muted)] truncate">
                {item.label}
              </div>
      ...
      <div className="flex gap-4 shrink-0">
        <div className="metric-card">
          ...
          <div className="text-xs text-[var(--deploymantis-text-muted)] mt-1 uppercase tracking-wider">
            Total Injections
          </div>
        </div>
        <div className="metric-card">
