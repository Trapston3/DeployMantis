              ...
              <div
                className={`
                  ...
                  ${isActive
                    ...
                    : isPast
                      ? "border-[var(--deploymantis-glass-border)] bg-[var(--deploymantis-glass-bg)]"
                ...
                <Icon
                  className={`w-6 h-6 transition-colors duration-300 ${
                    isActive
                      ...
                      : isPast
                        ? "text-[var(--accent)]/60"
                        : "text-[var(--deploymantis-text-muted)]"
                  }`}
                />
              </div>
              <div className="text-center">
                <div
                  className={`text-[10px] font-mono uppercase tracking-widest transition-colors duration-300 ${
                    isActive ? "text-[var(--accent)] font-bold glow-dot" : "text-[var(--deploymantis-text-muted)]"
                  }`}
                >
                  {hop.label}
                </div>
                ...
                <div className="relative w-full h-[1px]">
                  ...
                  <div
                    className={`
                      ...
                      ${activeHop > idx
                        ? "w-full duration-200 shadow-[0_0_8px_var(--deploymantis-accent-glow)]"
                        : activeHop === idx
                          ? "w-1/2 duration-300"
                          : "w-0 duration-100"
                      }
