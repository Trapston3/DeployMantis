          ...
          {keys.map((key, index) => {
            ...
            return (
              <div key={key} className="flex relative group whitespace-pre-wrap">
                ...
                <button
                  className="absolute right-0 top-0 opacity-0 group-hover:opacity-100 transition-opacity p-0.5 bg-black/40 hover:bg-[var(--accent)]/40 rounded text-[var(--aegis-text-muted)] hover:text-[var(--foreground)]"
                  title="Copy path"
